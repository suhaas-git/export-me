...
export const basicInfo: Inventory = {
	id: '6a-armoured',
	item: 'Armoured',
	itemDescription: 'CAT 6A Armoured Cable',
...
export const gallery: Gallery[] = [
	{
		type: 'image',
		src: 'https://orientcables.in/wp-content/uploads/2023/06/Thumb.png.webp',
		name: 'Armoured Cable',
		id: 'armoured-1'
	},
	{
		type: 'image',
		src: 'https://orientcables.in/wp-content/uploads/2023/06/Pop-up.png.webp',
		name: 'Armoured Cable',
		id: 'armoured-2'
	}
];
